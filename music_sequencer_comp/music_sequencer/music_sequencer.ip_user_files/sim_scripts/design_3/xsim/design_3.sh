...
#
# Script generated by Vivado on Mon Nov 20 17:16:58 +0900 2023
...
simulate()
{
  xsim design_3 -key {Behavioral:sim_1:Functional:design_3} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_3.protoinst" -log simulate.log
}
