...
#
# Script generated by Vivado on Mon Jan 15 17:23:38 +0900 2024
...
# script info
echo -e "blk_mem_gen_7.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_7 xil_defaultlib.blk_mem_gen_7 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_7 -key {Behavioral:sim_1:Functional:blk_mem_gen_7} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_3.protoinst" -log simulate.log
}
