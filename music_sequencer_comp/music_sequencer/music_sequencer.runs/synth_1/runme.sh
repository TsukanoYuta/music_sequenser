...
HD_PWD='C:/Users/yuta0/music_sequencer_2_copy/music_sequencer/music_sequencer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log famicom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source famicom.tcl
