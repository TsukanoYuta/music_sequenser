...
HD_PWD='C:/Users/yuta0/music_sequencer_2/music_sequencer/music_sequencer.runs/blk_mem_gen_Display_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_Display.tcl
